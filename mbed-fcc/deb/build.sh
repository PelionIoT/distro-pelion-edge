...
PELION_PACKAGE_SOURCE_PREPARATION_CALLBACK=pelion_mbed_fcc_source_preparation_cb
PELION_PACKAGE_ORIGIN_SOURCE_UPDATE_CALLBACK=pelion_mbed_fcc_origin_source_update_cb

declare -A PELION_PACKAGE_COMPONENTS=(
    ["https://github.com/PelionIoT/factory-configurator-client-example.git"]="4.13.1"
    ["https://github.com/PelionIoT/mbed-cloud-client.git"]="4.13.1")

source "$PELION_PACKAGE_DIR"/../../build-env/inc/build-common.sh

function pelion_mbed_fcc_source_preparation_cb() {
    cd "$PELION_SOURCE_DIR/$PELION_PACKAGE_NAME/factory-configurator-client-example"
    cp "$PELION_PACKAGE_DIR/debian/files/sotp_fs_linux.h" "./source/pal_config_linux.h"
}
